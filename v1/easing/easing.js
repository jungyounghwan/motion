...
// custom easing
export function easeShake(t, d) { return d * Math.sin(t*5*Math.PI) }
export function easeJelly(t, d) { return d * Math.sin(easeOutCubic(t)*3*Math.PI) }
export function easeBounce(t, d) { return d * Math.sin(easeInOutQuad(t)*3*Math.PI) }
